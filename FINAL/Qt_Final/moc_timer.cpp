...
QT_MOC_LITERAL(1, 6, 13), // "sigSocketRecv"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 13), // "page4RecvData"
QT_MOC_LITERAL(4, 35, 10) // "AlarmCheck"

    },
    "Timer\0sigSocketRecv\0\0page4RecvData\0"
    "AlarmCheck"
};
...
void Timer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->page4RecvData((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        {
            using _t = void (Timer::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Timer::sigSocketRecv)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Timer::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Timer::page4RecvData)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Timer::sigSocketRecv(QString _t1)
{
...
// SIGNAL 1
void Timer::page4RecvData(QString _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
